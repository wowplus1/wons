...
export const StoneRegisterForm: React.FC = () => {
  ...
  const [grade2Price, setGrade2Price] = useState('');
  const [grade3Price, setGrade3Price] = useState('');
  const [grade4Price, setGrade4Price] = useState('');
      ...
      <div className="glass-panel" style={{ width: '100%', maxWidth: '460px', background: 'var(--bg-surface-solid)', border: '1px solid var(--primary)' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', color: 'var(--text-muted)', marginBottom: '4px' }}>*이름</label>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '12px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', color: 'var(--text-muted)', marginBottom: '4px' }}>*사이즈</label>
              <input type="text" value={size} onChange={(e) => setSize(e.target.value)} className="input-field" style={{ width: '100%', padding: '6px' }} required />
            </div>
            <div>
          ...
          <div>
            <label style={{ display: 'block', fontSize: '14px', color: 'var(--text-muted)', marginBottom: '4px' }}>기타설명 (40자내)</label>
          ...
          <div style={{ border: '1px solid var(--border-color)', borderRadius: '8px', padding: '10px', background: 'rgba(255,255,255,0.01)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '6px' }}>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '2px' }}>1등급</label>
                <input type="number" value={grade1Price} onChange={(e) => setGrade1Price(e.target.value)} className="input-field" style={{ width: '100%', padding: '4px', textAlign: 'right', fontSize: '14px' }} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '2px' }}>2등급</label>
                <input type="number" value={grade2Price} onChange={(e) => setGrade2Price(e.target.value)} className="input-field" style={{ width: '100%', padding: '4px', textAlign: 'right', fontSize: '14px' }} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '2px' }}>3등급</label>
                <input type="number" value={grade3Price} onChange={(e) => setGrade3Price(e.target.value)} className="input-field" style={{ width: '100%', padding: '4px', textAlign: 'right', fontSize: '14px' }} />
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center', marginBottom: '2px' }}>4등급</label>
                <input type="number" value={grade4Price} onChange={(e) => setGrade4Price(e.target.value)} className="input-field" style={{ width: '100%', padding: '4px', textAlign: 'right', fontSize: '14px' }} />
              </div>
            </div>
          </div>
