      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '12px' }}>
        <h2 style={{ fontSize: '19px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span className="gradient-text" style={{ fontFamily: 'var(--font-title)', fontWeight: '600' }}>
            {activeTab === 'unpaid_ledger' ? '미수 대장' : activeTab === 'paid_ledger' ? '결제완료 대장' : '보류 대장'}
          </span>
            ...
            <>
              <button
                ...
                style={{
                  padding: '6px 16px',
                  fontSize: '15px',
                  background: selectedRows.length > 0 ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : '#e2e8f0',
                  color: selectedRows.length > 0 ? '#fff' : '#475569',
                  border: selectedRows.length > 0 ? 'none' : '1.5px solid #94a3b8',
                  fontWeight: 'bold',
                  borderRadius: '4px',
              ...
              <button
                ...
                style={{
                  padding: '6px 16px',
                  fontSize: '15px',
                  background: selectedRows.length > 0 ? 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' : '#e2e8f0',
                  color: selectedRows.length > 0 ? '#fff' : '#475569',
                  border: selectedRows.length > 0 ? 'none' : '1.5px solid #94a3b8',
                  fontWeight: 'bold',
                  borderRadius: '4px',
          ...
          {activeTab === 'paid_ledger' && (
            <button
              ...
              style={{
                padding: '6px 16px',
                fontSize: '15px',
                background: selectedRows.length > 0 ? 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)' : '#e2e8f0',
                color: selectedRows.length > 0 ? '#fff' : '#475569',
                border: selectedRows.length > 0 ? 'none' : '1.5px solid #94a3b8',
                fontWeight: 'bold',
                borderRadius: '4px',
          ...
          {activeTab === 'hold_ledger' && (
            <button
              ...
              style={{
                padding: '6px 16px',
                fontSize: '15px',
                background: selectedRows.length > 0 ? 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' : '#e2e8f0',
                color: selectedRows.length > 0 ? '#fff' : '#475569',
                border: selectedRows.length > 0 ? 'none' : '1.5px solid #94a3b8',
                fontWeight: 'bold',
                borderRadius: '4px',
