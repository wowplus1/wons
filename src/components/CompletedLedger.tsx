            ...
            <>
              <button
                ...
                style={{
                  padding: '6px 16px',
                  fontSize: '15px',
                  background: selectedRows.length > 0 ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : '#e5e7eb',
                  color: selectedRows.length > 0 ? '#fff' : '#9ca3af',
                  border: selectedRows.length > 0 ? 'none' : '1px solid #d1d5db',
                  fontWeight: 'bold',
                  borderRadius: '4px',
              ...
              <button
                ...
                style={{
                  padding: '6px 16px',
                  fontSize: '15px',
                  background: selectedRows.length > 0 ? 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' : '#e5e7eb',
                  color: selectedRows.length > 0 ? '#fff' : '#9ca3af',
                  border: selectedRows.length > 0 ? 'none' : '1px solid #d1d5db',
                  fontWeight: 'bold',
                  borderRadius: '4px',
          ...
          {activeTab === 'paid_ledger' && (
            <button
              ...
              style={{
                padding: '6px 16px',
                fontSize: '15px',
                background: selectedRows.length > 0 ? 'linear-gradient(135deg, #ef4444 0%, #dc2626 100%)' : '#e5e7eb',
                color: selectedRows.length > 0 ? '#fff' : '#9ca3af',
                border: selectedRows.length > 0 ? 'none' : '1px solid #d1d5db',
                fontWeight: 'bold',
                borderRadius: '4px',
          ...
          {activeTab === 'hold_ledger' && (
            <button
              ...
              style={{
                padding: '6px 16px',
                fontSize: '15px',
                background: selectedRows.length > 0 ? 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' : '#e5e7eb',
                color: selectedRows.length > 0 ? '#fff' : '#9ca3af',
                border: selectedRows.length > 0 ? 'none' : '1px solid #d1d5db',
                fontWeight: 'bold',
                borderRadius: '4px',
